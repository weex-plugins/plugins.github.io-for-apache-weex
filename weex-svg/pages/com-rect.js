...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/ali-130257n/www/weex-svg/demos/pages/com-rect.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	if (Component.options.functional) {console.error("[vue-loader] com-rect.vue: functional components are not supported with templates, they should use render functions.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-2e0e2993", Component.options)
	  } else {
	    hotAPI.reload("data-v-2e0e2993", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(5)("51621ec1", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!../../../../../../usr/local/lib/node_modules/weex-toolkit/node_modules/css-loader/index.js!../../../../../../usr/local/lib/node_modules/weex-toolkit/node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2e0e2993!../../../../../../usr/local/lib/node_modules/weex-toolkit/node_modules/vue-loader/lib/selector.js?type=styles&index=0!./com-rect.vue", function() {
	     var newContent = require("!!../../../../../../usr/local/lib/node_modules/weex-toolkit/node_modules/css-loader/index.js!../../../../../../usr/local/lib/node_modules/weex-toolkit/node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2e0e2993!../../../../../../usr/local/lib/node_modules/weex-toolkit/node_modules/vue-loader/lib/selector.js?type=styles&index=0!./com-rect.vue");
	     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
	     update(newContent);
	   });
	 }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: "desc"
	  }, [_vm._v("a simple rect componnet")])]), _vm._v(" "), _c('div', {
	    staticClass: "item"
	  }, [_c('svg', {
	    staticClass: "item-shape"
	  }, [_c('rect', {
	    ...
	    staticClass: "desc"
	  }, [_vm._v("use x and y to set the position of shape")])]), _vm._v(" "), _c('div', {
	    staticClass: "item"
	  }, [_c('svg', {
	    staticClass: "item-shape"
	  }, [_c('rect', {
	    ...
	    staticClass: "desc"
	  }, [_vm._v("use width and height to set the size of shape")])]), _vm._v(" "), _c('div', {
	    staticClass: "item"
	  }, [_c('svg', {
	    staticClass: "item-shape"
	  }, [_c('rect', {
	    ...
	    staticClass: "desc"
	  }, [_vm._v("use fill and stroke to set the color and outline of shape")])])])], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-2e0e2993", module.exports)
	  }
	}
